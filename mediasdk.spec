...
Version  : 22.6.5
Release  : 60
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.5/MediaSDK-22.6.5.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.5/MediaSDK-22.6.5.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.6.5
cd %{_builddir}/MediaSDK-intel-mediasdk-22.6.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672759094
mkdir -p clr-build
pushd clr-build
