...
Version  : 23.1.3
Release  : 64
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.3/MediaSDK-23.1.3.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.3/MediaSDK-23.1.3.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-23.1.3
cd %{_builddir}/MediaSDK-intel-mediasdk-23.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678463307
mkdir -p clr-build
pushd clr-build
