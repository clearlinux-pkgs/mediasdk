...
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.5.4/MediaSDK-22.5.4.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.5.4
cd %{_builddir}/MediaSDK-intel-mediasdk-22.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664554173
mkdir -p clr-build
pushd clr-build
