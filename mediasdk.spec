...
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.0/MediaSDK-22.6.0.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.6.0
cd %{_builddir}/MediaSDK-intel-mediasdk-22.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666278274
mkdir -p clr-build
pushd clr-build
