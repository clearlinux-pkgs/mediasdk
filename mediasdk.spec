...
Version  : 22.5.2
Release  : 52
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.5.2/MediaSDK-22.5.2.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.5.2/MediaSDK-22.5.2.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.5.2
cd %{_builddir}/MediaSDK-intel-mediasdk-22.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660143666
mkdir -p clr-build
pushd clr-build
