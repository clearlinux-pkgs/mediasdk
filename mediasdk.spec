...
Version  : 23.1.1
Release  : 62
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.1/MediaSDK-23.1.1.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.1/MediaSDK-23.1.1.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-23.1.1
cd %{_builddir}/MediaSDK-intel-mediasdk-23.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675783810
mkdir -p clr-build
pushd clr-build
