...
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-19.2.0.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-19.2.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1562802009
mkdir -p clr-build
pushd clr-build
