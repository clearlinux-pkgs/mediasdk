...
Version  : 19.1.0
Release  : 14
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-19.1.0.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-19.1.0.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-19.1.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1556566108
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libmfx.so.1.29
/usr/lib64/libmfxhw64.so.1
/usr/lib64/libmfxhw64.so.1.29
