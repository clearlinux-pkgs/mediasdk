...
Version  : 22.6.2
Release  : 57
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.2/MediaSDK-22.6.2.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.2/MediaSDK-22.6.2.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.6.2
cd %{_builddir}/MediaSDK-intel-mediasdk-22.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668092180
mkdir -p clr-build
pushd clr-build
