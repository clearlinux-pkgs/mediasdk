...
Version  : 22.6.1
Release  : 56
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.1/MediaSDK-22.6.1.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.1/MediaSDK-22.6.1.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.6.1
cd %{_builddir}/MediaSDK-intel-mediasdk-22.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667397702
mkdir -p clr-build
pushd clr-build
