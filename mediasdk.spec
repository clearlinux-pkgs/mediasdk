...
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-21.3.2/MediaSDK-21.3.2.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-21.3.2
cd %{_builddir}/MediaSDK-intel-mediasdk-21.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629470357
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/60e25f4a5bdd75aaaa1091247a05055c9c0e1e53
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/NOTICE %{buildroot}/usr/share/package-licenses/mediasdk/60e25f4a5bdd75aaaa1091247a05055c9c0e1e53
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/contrib/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/contrib/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/contrib/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.2/contrib/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build
%make_install
popd
