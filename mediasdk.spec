...
Version  : 23.1.4
Release  : 65
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.4/MediaSDK-23.1.4.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.4/MediaSDK-23.1.4.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-23.1.4
cd %{_builddir}/MediaSDK-intel-mediasdk-23.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679409981
mkdir -p clr-build
pushd clr-build
