...
Version  : 22.6.3
Release  : 58
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.3/MediaSDK-22.6.3.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-22.6.3/MediaSDK-22.6.3.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-22.6.3
cd %{_builddir}/MediaSDK-intel-mediasdk-22.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668787264
mkdir -p clr-build
pushd clr-build
