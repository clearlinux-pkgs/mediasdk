...
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-18.3.1.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-18.3.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1541019632
mkdir -p clr-build
pushd clr-build
