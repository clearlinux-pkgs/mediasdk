...
Version  : 23.1.2
Release  : 63
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.2/MediaSDK-23.1.2.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-23.1.2/MediaSDK-23.1.2.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-23.1.2
cd %{_builddir}/MediaSDK-intel-mediasdk-23.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676995426
mkdir -p clr-build
pushd clr-build
