...
Version  : 21.3.4
Release  : 34
URL      : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-21.3.4/MediaSDK-21.3.4.tar.gz
Source0  : https://github.com/Intel-Media-SDK/MediaSDK/archive/intel-mediasdk-21.3.4/MediaSDK-21.3.4.tar.gz
...
%prep
%setup -q -n MediaSDK-intel-mediasdk-21.3.4
cd %{_builddir}/MediaSDK-intel-mediasdk-21.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632839502
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/60e25f4a5bdd75aaaa1091247a05055c9c0e1e53
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/NOTICE %{buildroot}/usr/share/package-licenses/mediasdk/60e25f4a5bdd75aaaa1091247a05055c9c0e1e53
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/contrib/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/contrib/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/contrib/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/MediaSDK-intel-mediasdk-21.3.4/contrib/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mediasdk/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build
%make_install
popd
